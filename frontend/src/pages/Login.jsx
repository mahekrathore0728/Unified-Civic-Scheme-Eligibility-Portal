...
export default function Login() {
  ...
  return (
    <div className="civic-auth-container">
      ...
      <h1 className="civic-auth-title">Civic Portal Authentication</h1>
      <p className="civic-auth-subtitle">
        Access your government scheme tracker, saved applications, and document checklists.
      </p>
        ...
        <div className="civic-auth-body">
          {activeTab === 'admin' && (
            <div className="admin-notice-pill">
              <span>Departmental & Administrative Access Portal</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="auth-field-group">
              ...
              <input
                ...
                required
                autoComplete="email"
                placeholder={activeTab === 'admin' ? 'admin@civic.gov.in' : 'e.g. rahul@example.com'}
